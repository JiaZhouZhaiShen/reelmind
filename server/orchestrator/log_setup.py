"""ReelMind Orchestrator — rotating log file setup (standalone, no server dependency).

Writes to /data/reelmind/logs/reelmind-orchestrator.log + error.log
...
def setup_logging(service: str = "orchestrator") -> None:
    """Configure rotating file + console logging for an orchestrator-side service."""
    ...
    # Console (always — stdout for docker logs)
