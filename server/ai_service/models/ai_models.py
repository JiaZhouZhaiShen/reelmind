...
"""ReelMind AI data models (standalone copy for AI container).
These tables use a shared SQLite database, separate from the main PostgreSQL.
"""
...
_ai_engine = None
from sqlalchemy import event as _ai_event
...
def get_ai_engine(db_path=None):
    ...
    if _ai_engine is None:
        ...
        def _set_ai_sqlite_wal(dbapi_connection, connection_record):
            ...
            cursor.close()
        _ai_event.listen(_ai_engine, "connect", _set_ai_sqlite_wal)
